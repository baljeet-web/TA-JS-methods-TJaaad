...
*/
let quoteSplitted = console.log(quote.split(" "));
/*
...
*/
console.log(quote.lastIndexOf(`a`, lastIndex- 1));
/*
...
*/
let quotePadStart = quote.padStart(15, " .");
...
*/
let replaceToday = quote.replace(`today`, `tomorrow`);
console.log(replaceToday);
/*
